...
public class DetailsActivity extends AppCompatActivity {
    ...
    private void initItems() {
        ...
        private void initOnClickListeners() {
            ...
            btTakeScreenShot.setOnClickListener(view -> insertScreenshotInDb(takeWebviewScreenshot()));

            btAllegro.setOnClickListener(view -> {
                webSettings.setJavaScriptEnabled(true);
                if (!Objects.equals(activeView, "allegro")) {
            ...
            btCarrefour.setOnClickListener(view -> {
                //javascript breaks on this page. Simple workaround is to disable js.
                webSettings.setJavaScriptEnabled(false);
                if (!Objects.equals(activeView, "carrefour")) {
                    myWebView.clearCache(true);
            ...
            btObi.setOnClickListener(view -> {
                if (!Objects.equals(activeView, "obi")) {
                    webSettings.setJavaScriptEnabled(true);
                    myWebView.clearCache(true);
            ...
            btGoogle.setOnClickListener(view -> {
                if (!Objects.equals(activeView, "google")) {
                    webSettings.setJavaScriptEnabled(true);
                    myWebView.clearCache(true);
                    myWebView.loadUrl("https://www.google.com/search?q=" + code);
                    activeView = "google";
            ...
            btSaveLink.setOnClickListener(view -> insertSiteLinkInDb(myWebView.getUrl()));
        }
